        ...
        <div className="bg-[#0f1424]/90 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 shadow-[0_20px_80px_rgba(2,6,23,0.6)]">
          <div className="text-center mb-8 space-y-3">
            ...
            <div>
              ...
              <p className="text-gray-400">Email adresinize şifre sıfırlama linki göndereceğiz</p>
            </div>
          </div>
          ...
          {success ? (
            <div className="space-y-6">
              <div className="p-4 bg-primary-500/10 border border-primary-500/30 rounded-xl text-primary-200 text-sm">
                ...
                <p>
                  {email} adresine şifre sıfırlama linki gönderildi. Lütfen email kutunuzu kontrol edin.
                </p>
              </div>
              <Link
                href="/login"
                className="block w-full text-center bg-[linear-gradient(120deg,#7c3aed,#f97316,#06b6d4,#7c3aed)] animate-gradient text-white font-semibold py-3 rounded-2xl transition-all duration-300 shadow-[0_20px_45px_rgba(17,15,45,0.5)] hover:shadow-[0_30px_70px_rgba(124,58,237,0.35)]"
              >
                Giriş Sayfasına Dön
              </Link>
            </div>
